...
{//{{{
    ...
    //treein->Add("/Users/CeciliaD/Analysis/Bsphimumu/Nil/BToKstarMuMu/ROOTFILES/unfiltmc-genOnly/sel_BToKstarMuMu_NoFilt_8TeV_mc_genonly_s0.root");//yo agregue este archivo
    treein->Add("/Users/CeciliaD/Analysis/Bsphimumu/Nil/BToKstarMuMu/ROOTFILES/mc/sel_BToKstarMuMu_SCN_8TeV_normal_mc.lite_cut3-LHCb_s0.root");//tambien este
...
{//{{{
    ...
    //treein->Add("/Users/CeciliaD/Analysis/Bsphimumu/Nil/BToKstarMuMu/ROOTFILES/unfiltmc-genOnly/sel_BToKstarMuMu_NoFilt_8TeV_mc_genonly_s0.root");
    TChain *treein=ch;
    if (treein == NULL) {
